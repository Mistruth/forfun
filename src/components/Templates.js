...
const outdoorHikingTemplate = {
  ...
  blocks: [
    ...
    },
    {
      ...
      props: {
        segments: [
          { text: '楠木溪', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.25)' },
          { text: '：这是一条约4公里长的狭长河谷，周围群峰耸峙，谷中瀑布飞泻、溪流潺潺、叠泉幽潭、错落有致。这条溪流从邛崃山脉中缓缓流淌，清澈见底。四周青山环抱，绿树成荫。溪流的两岸，山势还是平缓，植被覆盖率超高，', bold: false, italic: false, underline: false, bgColor: '' },
          { text: '空气好的遭不住', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.2)' },
          { text: '。夏天来这里简直不要太凉快！', bold: false, italic: false, underline: false, bgColor: '' },
          { text: '\n\n放空自己走在路上，感受慢生活，耳听潺潺的流水声，感受着沿溪送来的阵阵山风，甚觉浑身舒畅，神情气爽，使人产生远离尘世的感慨。', bold: false, italic: false, underline: false, bgColor: '' },
        ],
        fontSize: '17',
        lineHeight: '1.9',
        hasBg: false,
    ...
    },
    {
      ...
      props: {
        segments: [
          ...
          { text: ' 进阶徒步线', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.2)' },
          { text: '\n\n徒步距离：', bold: true, italic: false, underline: false, bgColor: '' },
          { text: '8-10公里', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.2)' },
          { text: '\n✦ 下车后先参观"红军长征纪念馆"（半小时）\n✦ 从楠木溪沟口进入，全长约4公里\n✦ 午餐后继续徒步，可穿越到纪念馆上车或原路往返', bold: false, italic: false, underline: false, bgColor: '' },
        ],
        fontSize: '17',
        lineHeight: '1.9',
        hasBg: true,
    ...
    },
    {
      ...
      props: {
        segments: [
          ...
          { text: ' 轻松休闲线\n', bold: true, italic: false, underline: false, bgColor: 'rgba(99,179,237,0.2)' },
          { text: '\n✦ 参观红军长征纪念馆\n✦ 楠木溪沟口徒步4公里\n✦ 午餐后在农家乐自由玩耍，享受悠闲时光', bold: false, italic: false, underline: false, bgColor: '' },
        ],
        fontSize: '17',
        lineHeight: '1.9',
        hasBg: true,
    ...
    },
    {
      ...
      props: {
        segments: [
          ...
          { text: '2026年5月17日（周天）', bold: false, italic: false, underline: false, bgColor: '' },
          { text: '\n活动地点：', bold: true, italic: false, underline: false, bgColor: '' },
          { text: '邛崃 - 楠木溪', bold: false, italic: false, underline: false, bgColor: '' },
          { text: '\n活动主题：', bold: true, italic: false, underline: false, bgColor: '' },
          { text: '纳凉/吸氧休闲游', bold: false, italic: false, underline: false, bgColor: '' },
          { text: '\n徒步路线：', bold: true, italic: false, underline: false, bgColor: '' },
          { text: 'A线8-10㎞，B线3-5㎞', bold: false, italic: false, underline: false, bgColor: '' },
          { text: '\n活动形式：', bold: true, italic: false, underline: false, bgColor: '' },
          { text: '包车，AA结伴同行', bold: false, italic: false, underline: false, bgColor: '' },
          { text: '\nAA费用：', bold: true, italic: false, underline: false, bgColor: '' },
          { text: '80元/人', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.25)' },
        ],
        fontSize: '17',
        lineHeight: '2.0',
        hasBg: true,
    ...
    },
    {
      ...
      props: {
        segments: [
          { text: '🚌  08:00', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.2)' },
          ...
          { text: '  午餐时间，AB线分流\n', bold: false, italic: false, underline: false, bgColor: '' },
          { text: '🏔️  16:00', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.2)' },
          { text: '  收队返程，所有徒友上车 🚌\n', bold: false, italic: false, underline: false, bgColor: '' },
          { text: '🏠  18:00', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.2)' },
          { text: '  预计回到成都，期待下次再见 👋', bold: false, italic: false, underline: false, bgColor: '' },
        ],
        fontSize: '17',
        lineHeight: '2.0',
        hasBg: false,
