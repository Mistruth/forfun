...
const outdoorHikingTemplate = {
  ...
  blocks: [
    ...
    },
    {
      ...
      props: {
        segments: [
          ...
          { text: '3000+', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.18)' },
    ...
    },
    {
      ...
      props: {
        segments: [
          { text: '牟托羌寨', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.18)' },
          { text: '，位于阿坝州茂县，是一座依山而建的古老羌族村落。寨子四周青山环抱，碉楼矗立，石板路蜿蜒其间，保留着浓郁的羌族风情。初夏时节，满山的', bold: false, italic: false, underline: false, bgColor: '' },
          { text: '高山车厘子', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.18)' },
    ...
    },
    {
      ...
      props: {
        segments: [
          ...
          { text: '350元/人', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.18)' },
        ],
        fontSize: '17',
        lineHeight: '2.0',
        hasBg: true,
    ...
    // ── Day1 行程时间线 ──
    {
      ...
      props: {
        items: [
          '08:30  桐梓林地铁B口集合出发 🚐',
          '11:00  预计抵达汶川"水磨沟"下车点',
          '轻徒步  沿山路徒步至牟托羌寨，约3公里，路线轻松新手友好 🥾',
    ...
    },
    {
      ...
      props: {
        segments: [
          { text: '夜晚可以在羌寨自由闲逛，感受山里的慢节奏与初夏夜风🌙', bold: false, italic: true, underline: false, bgColor: '' },
        ],
        fontSize: '15',
        lineHeight: '1.85',
        hasBg: false,
    ...
    },
    {
      ...
      props: {
        segments: [
          { text: '🍜  08:30  早餐统一安排', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.18)' },
    ...
    // ── A线 ──
    {
      ...
      props: {
        ...
        variant: 'classic',
        title: '🥾 A线 ｜ 漆树坪轻徒步',
        content: '跟随领队前往"漆树坪"轻徒步，往返约5公里。\n☞ 适合喜欢徒步、拍照、想多走一点山路的徒友\n☞ 徒步结束后返回羌寨，可自由购买、采摘车厘子🍒',
        customIcon: '',
        fontFamily: YOUYUAN,
      },
    },
    // ── B线 ──
    {
      ...
      props: {
        ...
        variant: 'classic',
        title: '🍒 B线 ｜ 车厘子采摘休闲线',
        content: '不参加徒步的徒友，可直接前往果园自由采摘车厘子。\n☞ 轻松休闲，适合慢游、拍照、发呆晒太阳☀️',
        customIcon: '',
        fontFamily: YOUYUAN,
      },
    },
    ...
    },
    {
      ...
      props: {
        segments: [
          ...
          { text: '\n', bold: false, italic: false, underline: false, bgColor: '' },
          { text: '把初夏的甜味，装进一筐车厘子里。🍒', bold: true, italic: true, underline: false, bgColor: 'rgba(62,207,142,0.12)' },
        ],
        fontSize: '18',
        lineHeight: '2.0',
        hasBg: false,
    ...
    },
    {
      ...
      props: {
        segments: [
          ...
          { text: '❶ 户外活动存在危险与不确定性', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.18)' },
          ...
          { text: '❷ 责任声明', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.18)' },
          ...
          { text: '❸ 免责条款', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.18)' },
          ...
          { text: '❹ 关于交通工具的责任条款', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.18)' },
          { text: '\n户外活动所乘的交通工具，遵循哪里上车哪里下车的原则，中途不能要求司机按照自己的意愿停靠，同时，租车活动来回途中因交通事故造成乘员人身伤害和财产损失，按有关法律法规处理，发起人和同行人员不承担任何责任。\n', bold: false, italic: false, underline: false, bgColor: '' },
          { text: '❺ 报名即视为接受声明', bold: true, italic: false, underline: false, bgColor: 'rgba(62,207,142,0.18)' },
